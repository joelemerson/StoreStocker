...
/**
 * Displays list of com.example.android.items that were entered and stored in the app.
 */
public class CatalogActivity extends AppCompatActivity implements
    ...
    /**
     * Helper method to delete all com.example.android.items in the database.
     */
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            // Respond to a click on the "Insert items" menu option
